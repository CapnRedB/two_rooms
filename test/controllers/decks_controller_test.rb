...
class DecksControllerTest < ActionController::TestCase
  ...
  test "should create deck" do
    assert_difference('Deck.count') do
      post :create, deck: { bury: @deck.bury, description: @deck.description, name: @deck.name, user_id: @deck.user_id }
    end
  ...
  test "should update deck" do
    patch :update, id: @deck, deck: { bury: @deck.bury, description: @deck.description, name: @deck.name, user_id: @deck.user_id }
    assert_redirected_to deck_path(assigns(:deck))
  end
